...
insert into product_data values ('P000001','A beautiful jean','P000001','4.07','1');
insert into product_data values ('P000002','A beautiful jean0002','P000001','3.29','1');
...
insert into rating_data values ('R000001','P000001','P000001','1','2018-12-24 19:18:52','1');
insert into rating_data values ('R000002','P000001','P000001','2','2018-12-23 17:09:29','1');
insert into rating_data values ('R000003','P000002','P000002','3','2019-01-01 02:49:24','1');
insert into rating_data values ('R000004','P000003','P000002','4','2018-12-29 23:44:48','1');

	
insert into review_data values ('R000001','Credit Card','一段图片的描述，说明了该场景的实际效果。

同时说明了一些可能出现的问题。
','P000001','P000001','2019-01-03 08:50:29','1');
insert into review_data values ('R000002','GiftCard','一段图片的描述，说明了该场景的实际效果。

同时说明了一些可能出现的问题。
','P000001','P000001','2018-12-20 12:54:09','1');
insert into review_data values ('R000003','Credit Card','一段图片的描述，说明了该场景的实际效果。

同时说明了一些可能出现的问题。
','P000002','P000002','2018-12-21 04:11:02','1');
insert into review_data values ('R000004','GiftCard','一段图片的描述，说明了该场景的实际效果。

同时说明了一些可能出现的问题。
','P000003','P000002','2019-01-08 17:41:21','1');

	
insert into blog_data values ('B000001','a consumer order','一段图片的描述，说明了该场景的实际效果。

同时说明了一些可能出现的问题。
','P000001','P000001','2018-12-23 09:07:36','1');
insert into blog_data values ('B000002','a consumer order0002','一段图片的描述，说明了该场景的实际效果。

同时说明了一些可能出现的问题。
','P000001','P000001','2018-12-20 02:12:10','1');
insert into blog_data values ('B000003','a consumer order0003','一段图片的描述，说明了该场景的实际效果。

同时说明了一些可能出现的问题。
','P000002','P000002','2019-01-02 09:41:22','1');
insert into blog_data values ('B000004','a consumer order0004','一段图片的描述，说明了该场景的实际效果。

同时说明了一些可能出现的问题。
','P000003','P000002','2018-12-27 12:15:08','1');
...
insert into sec_user_data values ('SU000001','login','13900000001','','C183EC89F92A462CF45B95504792EC4625E847C90536EEFE512D1C9DB8602E95','0','2018-12-26 04:38:54','2018-12-27 11:24:46','UD000001',NULL,'BLOCKED','1');
insert into sec_user_data values ('SU000002','login0002','13900000002','suddy_chang@163.com','AC2F95628244C6975EB2C36942EA879ED93D93F5895EF3157733E4629FA86B92','9999999','2019-01-07 05:21:36','2018-12-24 21:00:23','UD000001',NULL,'BLOCKED0002','1');

	
insert into sec_user_blocking_data values ('SUB000001','currentUser()','2018-12-19 18:43:27','这个用户多次发送违反社区的帖子，现在把他给屏蔽了','1');
...
insert into login_history_data values ('LH000001','2018-12-31 23:52:10','192.168.1.1','登陆成功','SU000001','1');
insert into login_history_data values ('LH000002','2019-01-02 18:42:22','192.168.1.2','登陆成功0002','SU000001','1');
insert into login_history_data values ('LH000003','2018-12-19 08:08:16','192.168.1.1','登陆成功0003','SU000002','1');
insert into login_history_data values ('LH000004','2019-01-03 12:15:13','192.168.1.2','登陆成功0004','SU000002','1');
