...
import com.doublechaintech.ugc.secuserblocking.SecUserBlockingDAO;
import com.doublechaintech.ugc.userdomain.UserDomainDAO;
import com.doublechaintech.ugc.userapp.UserAppDAO;
import com.doublechaintech.ugc.loginhistory.LoginHistoryDAO;



import org.springframework.dao.EmptyResultDataAccessException;

public class SecUserJDBCTemplateDAO extends UgcNamingServiceDAO implements SecUserDAO{
	...
	*/
    ...
    public SmartList<SecUser> requestCandidateSecUserForUserApp(UgcUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
    ...
    public SmartList<SecUser> requestCandidateSecUserForLoginHistory(UgcUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
        // NOTE: by default, ignore owner info, just return all by filter key.
		// You need override this method if you have different candidate-logic
		return findAllCandidateByFilter(SecUserTable.COLUMN_LOGIN, filterKey, pageNo, pageSize, getSecUserMapper());
    }
