...
import com.doublechaintech.ugc.secuser.SecUserCustomManagerImpl;
import com.doublechaintech.ugc.userapp.UserApp;
import com.doublechaintech.ugc.userapp.UserAppTokens;
import com.terapico.utils.CollectionUtils;

public class UgcUserContextImpl extends UserContextImpl implements UgcUserContext{
	...
	static final String RESOURCE_PATH="com.doublechaintech.ugc.UgcResources";
	static final String CUSTOM_RESOURCE_PATH="com.doublechaintech.ugc.UgcCustomResources";
    ...
    /*
    public static SecUser getSecUser(UgcUserContext userContext) {
	...
	public static UserApp getSingleUserAppByObjectName(UgcUserContext userContext, String objectName)
			throws Exception {
		SecUserCustomManagerImpl secUserManager = (SecUserCustomManagerImpl) userContext.getManagerGroup()
				.getSecUserManager();
		SecUser secUser = secUserManager.getCachedSecUser(userContext);
	...
	*/
	public static SmartList<UserApp> getUserAppByName(UgcUserContext userContext, SecUser secUser, String objectName) {
	...
	public static UserApp getUserAppByBindedEntity(UgcUserContext userContext, BaseEntity userAppBindedObject) {
		MultipleAccessKey key = new MultipleAccessKey();
