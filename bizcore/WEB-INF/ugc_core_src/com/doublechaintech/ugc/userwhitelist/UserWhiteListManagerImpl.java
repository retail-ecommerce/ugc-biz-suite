...
public class UserWhiteListManagerImpl extends CustomUgcCheckerManager implements UserWhiteListManager {
	...
	protected void throwExceptionWithMessage(String value) throws UserWhiteListManagerException{
 	...
 	protected UserWhiteList saveUserWhiteList(UgcUserContext userContext, UserWhiteList userWhiteList, String [] tokensExpr) throws Exception{	
 	...
 	protected UserWhiteList saveUserWhiteListDetail(UgcUserContext userContext, UserWhiteList userWhiteList) throws Exception{	
 	...
 	public UserWhiteList loadUserWhiteList(UgcUserContext userContext, String userWhiteListId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public UserWhiteList searchUserWhiteList(UgcUserContext userContext, String userWhiteListId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected UserWhiteList present(UgcUserContext userContext, UserWhiteList userWhiteList, Map<String, Object> tokens) throws Exception {
 	...
 	public UserWhiteList loadUserWhiteListDetail(UgcUserContext userContext, String userWhiteListId) throws Exception{	
 	...
 	public Object view(UgcUserContext userContext, String userWhiteListId) throws Exception{	
 		UserWhiteList userWhiteList = loadUserWhiteList( userContext, userWhiteListId, viewTokens());
 		return present(userContext,userWhiteList, allTokens());
		
 	}
 	protected UserWhiteList saveUserWhiteList(UgcUserContext userContext, UserWhiteList userWhiteList, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getUserWhiteListDAO().save(userWhiteList, tokens);
 	}
 	protected UserWhiteList loadUserWhiteList(UgcUserContext userContext, String userWhiteListId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfUserWhiteList(userWhiteListId);
		userContext.getChecker().throwExceptionIfHasErrors( UserWhiteListManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(UgcUserContext userContext, UserWhiteList userWhiteList, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(UgcUserContext userContext, UserWhiteList userWhiteList, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingUserWhiteList(UgcUserContext userContext,String userWhiteListId, int userWhiteListVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public UserWhiteList clone(UgcUserContext userContext, String fromUserWhiteListId) throws Exception{
	...
	public UserWhiteList internalSaveUserWhiteList(UgcUserContext userContext, UserWhiteList userWhiteList, Map<String,Object> options) throws Exception 
	{
	...
	public UserWhiteList updateUserWhiteListProperty(UgcUserContext userContext,String userWhiteListId, int userWhiteListVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingUserWhiteList(userContext, userWhiteListId, userWhiteListVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherDomain(UgcUserContext userContext, String userWhiteListId, String anotherDomainId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(UgcUserContext userContext, String userWhiteListId, int userWhiteListVersion) throws Exception {
	...
	public UserWhiteList forgetByAll(UgcUserContext userContext, String userWhiteListId, int userWhiteListVersion) throws Exception {
		return forgetByAllInternal(userContext, userWhiteListId, userWhiteListVersion);		
	}
	protected UserWhiteList forgetByAllInternal(UgcUserContext userContext,
			String userWhiteListId, int userWhiteListVersion) throws Exception{
