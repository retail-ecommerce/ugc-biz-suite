...
public class LoginHistoryManagerImpl extends CustomUgcCheckerManager implements LoginHistoryManager {
	...
	protected void throwExceptionWithMessage(String value) throws LoginHistoryManagerException{
 	...
 	protected LoginHistory saveLoginHistory(UgcUserContext userContext, LoginHistory loginHistory, String [] tokensExpr) throws Exception{	
 	...
 	protected LoginHistory saveLoginHistoryDetail(UgcUserContext userContext, LoginHistory loginHistory) throws Exception{	
 	...
 	public LoginHistory loadLoginHistory(UgcUserContext userContext, String loginHistoryId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public LoginHistory searchLoginHistory(UgcUserContext userContext, String loginHistoryId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected LoginHistory present(UgcUserContext userContext, LoginHistory loginHistory, Map<String, Object> tokens) throws Exception {
 	...
 	public LoginHistory loadLoginHistoryDetail(UgcUserContext userContext, String loginHistoryId) throws Exception{	
 	...
 	public Object view(UgcUserContext userContext, String loginHistoryId) throws Exception{	
 		LoginHistory loginHistory = loadLoginHistory( userContext, loginHistoryId, viewTokens());
 		return present(userContext,loginHistory, allTokens());
		
 	}
 	protected LoginHistory saveLoginHistory(UgcUserContext userContext, LoginHistory loginHistory, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getLoginHistoryDAO().save(loginHistory, tokens);
 	}
 	protected LoginHistory loadLoginHistory(UgcUserContext userContext, String loginHistoryId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfLoginHistory(loginHistoryId);
		userContext.getChecker().throwExceptionIfHasErrors( LoginHistoryManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(UgcUserContext userContext, LoginHistory loginHistory, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(UgcUserContext userContext, LoginHistory loginHistory, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingLoginHistory(UgcUserContext userContext,String loginHistoryId, int loginHistoryVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public LoginHistory clone(UgcUserContext userContext, String fromLoginHistoryId) throws Exception{
	...
	public LoginHistory internalSaveLoginHistory(UgcUserContext userContext, LoginHistory loginHistory, Map<String,Object> options) throws Exception 
	{
	...
	public LoginHistory updateLoginHistoryProperty(UgcUserContext userContext,String loginHistoryId, int loginHistoryVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingLoginHistory(userContext, loginHistoryId, loginHistoryVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherSecUser(UgcUserContext userContext, String loginHistoryId, String anotherSecUserId) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithLogin(UgcUserContext userContext, String loginHistoryId, String anotherLogin) throws Exception
 	{
 	...
 	public LoginHistory transferToAnotherSecUserWithLogin(UgcUserContext userContext, String loginHistoryId, String anotherLogin) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithEmail(UgcUserContext userContext, String loginHistoryId, String anotherEmail) throws Exception
 	{
 	...
 	public LoginHistory transferToAnotherSecUserWithEmail(UgcUserContext userContext, String loginHistoryId, String anotherEmail) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithMobile(UgcUserContext userContext, String loginHistoryId, String anotherMobile) throws Exception
 	{
 	...
 	public LoginHistory transferToAnotherSecUserWithMobile(UgcUserContext userContext, String loginHistoryId, String anotherMobile) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public void delete(UgcUserContext userContext, String loginHistoryId, int loginHistoryVersion) throws Exception {
	...
	public LoginHistory forgetByAll(UgcUserContext userContext, String loginHistoryId, int loginHistoryVersion) throws Exception {
		return forgetByAllInternal(userContext, loginHistoryId, loginHistoryVersion);		
	}
	protected LoginHistory forgetByAllInternal(UgcUserContext userContext,
			String loginHistoryId, int loginHistoryVersion) throws Exception{
