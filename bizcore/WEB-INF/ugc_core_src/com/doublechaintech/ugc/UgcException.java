...
@JsonSerialize(using = UgcExceptionJsonSerializer.class)
public class UgcException extends Exception implements MessageContainer {
    ...
    public UgcException(String message) {
        super(message);
    }
    public UgcException(Message message) {
    	super();
        this.addErrorMessage(message);
    }
	public UgcException(List<Message> messageList) {
        super();
    ...
    public UgcException(String message, Throwable cause) {
        super(message, cause);
    }


    public UgcException(Throwable cause) {
        super(cause);
    }
