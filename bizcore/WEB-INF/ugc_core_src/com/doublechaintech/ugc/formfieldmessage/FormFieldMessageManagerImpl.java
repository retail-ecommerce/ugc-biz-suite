...
import com.doublechaintech.ugc.genericform.CandidateGenericForm;
...
public class FormFieldMessageManagerImpl extends CustomUgcCheckerManager implements FormFieldMessageManager {
	...
	protected void throwExceptionWithMessage(String value) throws FormFieldMessageManagerException{
 	...
 	protected FormFieldMessage saveFormFieldMessage(UgcUserContext userContext, FormFieldMessage formFieldMessage, String [] tokensExpr) throws Exception{	
 	...
 	protected FormFieldMessage saveFormFieldMessageDetail(UgcUserContext userContext, FormFieldMessage formFieldMessage) throws Exception{	
 	...
 	public FormFieldMessage loadFormFieldMessage(UgcUserContext userContext, String formFieldMessageId, String [] tokensExpr) throws Exception{				
 	 ...
 	 public FormFieldMessage searchFormFieldMessage(UgcUserContext userContext, String formFieldMessageId, String textToSearch,String [] tokensExpr) throws Exception{				
 	...
 	protected FormFieldMessage present(UgcUserContext userContext, FormFieldMessage formFieldMessage, Map<String, Object> tokens) throws Exception {
 	...
 	public FormFieldMessage loadFormFieldMessageDetail(UgcUserContext userContext, String formFieldMessageId) throws Exception{	
 	...
 	public Object view(UgcUserContext userContext, String formFieldMessageId) throws Exception{	
 		FormFieldMessage formFieldMessage = loadFormFieldMessage( userContext, formFieldMessageId, viewTokens());
 		return present(userContext,formFieldMessage, allTokens());
		
 	}
 	protected FormFieldMessage saveFormFieldMessage(UgcUserContext userContext, FormFieldMessage formFieldMessage, Map<String,Object>tokens) throws Exception{	
 		return userContext.getDAOGroup().getFormFieldMessageDAO().save(formFieldMessage, tokens);
 	}
 	protected FormFieldMessage loadFormFieldMessage(UgcUserContext userContext, String formFieldMessageId, Map<String,Object>tokens) throws Exception{	
		userContext.getChecker().checkIdOfFormFieldMessage(formFieldMessageId);
		userContext.getChecker().throwExceptionIfHasErrors( FormFieldMessageManagerException.class);
 	...
 	protected<T extends BaseEntity> void addActions(UgcUserContext userContext, FormFieldMessage formFieldMessage, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(UgcUserContext userContext, FormFieldMessage formFieldMessage, Map<String, Object> tokens){
	...
	protected void checkParamsForUpdatingFormFieldMessage(UgcUserContext userContext,String formFieldMessageId, int formFieldMessageVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public FormFieldMessage clone(UgcUserContext userContext, String fromFormFieldMessageId) throws Exception{
	...
	public FormFieldMessage internalSaveFormFieldMessage(UgcUserContext userContext, FormFieldMessage formFieldMessage, Map<String,Object> options) throws Exception 
	{
	...
	public FormFieldMessage updateFormFieldMessageProperty(UgcUserContext userContext,String formFieldMessageId, int formFieldMessageVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception 
	{
		checkParamsForUpdatingFormFieldMessage(userContext, formFieldMessageId, formFieldMessageVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherForm(UgcUserContext userContext, String formFieldMessageId, String anotherFormId) throws Exception
 	{
	...
	public CandidateGenericForm requestCandidateForm(UgcUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected GenericForm loadGenericForm(UgcUserContext userContext, String newFormId, Map<String,Object> options) throws Exception
 	{
	...
	public void delete(UgcUserContext userContext, String formFieldMessageId, int formFieldMessageVersion) throws Exception {
	...
	public FormFieldMessage forgetByAll(UgcUserContext userContext, String formFieldMessageId, int formFieldMessageVersion) throws Exception {
		return forgetByAllInternal(userContext, formFieldMessageId, formFieldMessageVersion);		
	}
	protected FormFieldMessage forgetByAllInternal(UgcUserContext userContext,
			String formFieldMessageId, int formFieldMessageVersion) throws Exception{
