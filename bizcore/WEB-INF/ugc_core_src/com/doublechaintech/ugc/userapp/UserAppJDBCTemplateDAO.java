...
import com.doublechaintech.ugc.listaccess.ListAccessDAO;
import com.doublechaintech.ugc.objectaccess.ObjectAccessDAO;



import org.springframework.dao.EmptyResultDataAccessException;

public class UserAppJDBCTemplateDAO extends UgcNamingServiceDAO implements UserAppDAO{
	...
	*/
    ...
    public SmartList<UserApp> requestCandidateUserAppForListAccess(UgcUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
    ...
    public SmartList<UserApp> requestCandidateUserAppForObjectAccess(UgcUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
        // NOTE: by default, ignore owner info, just return all by filter key.
		// You need override this method if you have different candidate-logic
		return findAllCandidateByFilter(UserAppTable.COLUMN_TITLE, filterKey, pageNo, pageSize, getUserAppMapper());
    }
