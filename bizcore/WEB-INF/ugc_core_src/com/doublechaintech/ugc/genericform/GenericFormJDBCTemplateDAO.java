...
import com.doublechaintech.ugc.formfieldmessage.FormFieldMessageDAO;
import com.doublechaintech.ugc.formmessage.FormMessageDAO;
import com.doublechaintech.ugc.formfield.FormFieldDAO;
import com.doublechaintech.ugc.formaction.FormActionDAO;



import org.springframework.dao.EmptyResultDataAccessException;

public class GenericFormJDBCTemplateDAO extends UgcNamingServiceDAO implements GenericFormDAO{
	...
	*/
    ...
    public SmartList<GenericForm> requestCandidateGenericFormForFormMessage(UgcUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
    ...
    public SmartList<GenericForm> requestCandidateGenericFormForFormFieldMessage(UgcUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
        // NOTE: by default, ignore owner info, just return all by filter key.
		// You need override this method if you have different candidate-logic
		return findAllCandidateByFilter(GenericFormTable.COLUMN_TITLE, filterKey, pageNo, pageSize, getGenericFormMapper());
    }
		
    public SmartList<GenericForm> requestCandidateGenericFormForFormField(UgcUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
        // NOTE: by default, ignore owner info, just return all by filter key.
		// You need override this method if you have different candidate-logic
		return findAllCandidateByFilter(GenericFormTable.COLUMN_TITLE, filterKey, pageNo, pageSize, getGenericFormMapper());
    }
		
    public SmartList<GenericForm> requestCandidateGenericFormForFormAction(UgcUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
        // NOTE: by default, ignore owner info, just return all by filter key.
		// You need override this method if you have different candidate-logic
		return findAllCandidateByFilter(GenericFormTable.COLUMN_TITLE, filterKey, pageNo, pageSize, getGenericFormMapper());
    }
