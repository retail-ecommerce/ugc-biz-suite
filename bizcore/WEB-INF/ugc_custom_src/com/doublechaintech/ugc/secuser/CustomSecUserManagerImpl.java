...
import com.doublechaintech.ugc.UgcUserContextImpl;
import com.doublechaintech.ugc.LoginForm;
import com.doublechaintech.ugc.BaseEntity;
import com.doublechaintech.ugc.CommonError;
import com.doublechaintech.ugc.DAOGroup;
import com.doublechaintech.ugc.ManagerGroup;

import com.doublechaintech.ugc.UserContextImpl;
import com.doublechaintech.ugc.userapp.UserApp;
import com.doublechaintech.ugc.UgcUserContext;
import com.doublechaintech.ugc.userapp.*;
import com.doublechaintech.ugc.listaccess.*;
import com.doublechaintech.ugc.objectaccess.*;
import com.doublechaintech.ugc.UgcChecker;
...
public class CustomSecUserManagerImpl extends SecUserManagerImpl implements
    ...
    public String confirmSession(UgcUserContext userContext){
    ...
    public Object resetPassword(UgcUserContext userContext, String mobile, int verifycationCode, String newPassword) {
    ...
    public Object resetPasswordWithoutLogin(UgcUserContext userContext, String loginType, String loginKey, int verifycationCode, String newPassword) {
        SecUser user;
        try {
    ...
    public Object selectApp(UgcUserContext userContext,
    ...
    public SecUser manage(UgcUserContext userContext) throws Exception{
        SecUser user = cachedUser(userContext);
    ...
    protected SecUser cachedUser(UgcUserContext userContext)
    {
        return (SecUser)userContext.getCachedObject(this.getUserKey(userContext), SecUser.class);
    }
    
    public SecUser getCachedSecUser(UgcUserContext userContext) {
    ...
    protected Object gotoApp(UgcUserContext userContext, UserApp app) throws Exception {
    ...
    public String getVerificationCode(UgcUserContext userContext,String mobile){
    ...
    protected void sendVerificationCode(UgcUserContext userContext, String mobile,String code) throws Exception{
    ...
    protected int getRandomVerificationCode(UgcUserContext userContex, int length){
    ...
    protected String getBeanName(UgcUserContext userContext, UserApp app){
    ...
    protected String getTargetObjectId(UgcUserContext userContext, UserApp app){
        
        return  app.getObjectId();
        
    }
    protected String getServiceType(UgcUserContext userContext, UserApp app){
        
        return app.getObjectType();
    }
    protected String getMethodName(UgcUserContext userContext, UserApp app){
    ...
    public Object home(UgcUserContext userContext) {
    ...
    public Object loginWithEmail(UgcUserContext userContext, String email,
            String password) {

        return loginInternal(userContext,"email",email, password);
    
    }
    public Object login(UgcUserContext userContext, String email,
            String password) {
    ...
    public Object loginWithLogin(UgcUserContext userContext, String email,
            String password) {

        return loginInternal(userContext,"login",email, password);
    
    }
    public Object loginWithMobile(UgcUserContext userContext, String email,
            String password) {
        return loginInternal(userContext,"mobile",email, password);
    
    }
    protected SecUser loadUserWith(UgcUserContext userContext, String type, String userId) throws Exception{
    ...
    protected Object loginInternal(UgcUserContext userContext, String type, String userId,
            String password) {
     ...
     */
    protected Object loginTheSecUserInternal(UgcUserContext userContext, SecUser user, String loginComments) throws Exception {
    ...
    public Object showlogin(UgcUserContext userContext) {
    ...
    protected LoginForm showSessionExpired(UgcUserContext userContext) {
    ...
    public BaseUserContext loadUserConext(HttpServletRequest request)
        ...
        UgcUserContextImpl uc = createNewConext(path);
        init(uc, request);
        return uc;
    }
    ...
    protected UgcChecker checker;
    public UgcChecker getChecker(){
        return checker;
    }
    
    public void setChecker(UgcChecker checker){
    ...
    protected void init(UserContextImpl userContext, HttpServletRequest request) {
        ...
        userContext.setChecker((UgcChecker)beanFactory.getBean(getCheckerBeanName()));
    ...
    protected UgcUserContextImpl createNewConext(String path) {

        return new UgcUserContextImpl();
    ...
    public Object checkOtherLogin(UgcUserContext userContext) throws Exception {
	...
	protected void checkUserHasManagementAccess(UgcUserContext userContext, String objectType, String objectId)
	...
	public UserApp updateAppPermission(UgcUserContext userContext, String secUserId, String userAppId, int version,
	...
	public UserApp updateListAccess(UgcUserContext userContext, String secUserId, String userAppId, String displayName,
	...
	public UserApp loadUserAppWithUser(UgcUserContext userContext, String secUserId, String objectType,
    ...
    public Object changeCurUserPassword(UgcUserContext userContext, String currentPassword, String newPassword)
			throws Exception {
	...
	public String testIfHasManagementAccess(UgcUserContext userContext,String objectType,String objectId) {
		try {
			this.checkUserHasManagementAccess(userContext, objectType, objectId);
			return "OK";
		}catch(Exception e){
