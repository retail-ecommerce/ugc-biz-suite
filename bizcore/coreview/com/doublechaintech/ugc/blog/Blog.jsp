<%@ page import='java.util.*,com.doublechaintech.ugc.*,com.doublechaintech.ugc.blog.Blog'%>
...
<c:set var="ownerBeanName" value="blog" scope="request"/>
<c:set var="ownerClassName" value="Blog" scope="request"/>
...
<div class="row">
	...
	<% Blog result = (Blog)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="blog" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/ugc/blog/Blog$Summary.jsp" />
