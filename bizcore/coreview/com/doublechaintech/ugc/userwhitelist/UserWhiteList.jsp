<%@ page import='java.util.*,com.doublechaintech.ugc.*,com.doublechaintech.ugc.userwhitelist.UserWhiteList'%>
...
<sky:include page="com/doublechaintech/ugc/userwhitelist/UserWhiteList$Summary.jsp" />
