<%@ page import='java.util.*,com.doublechaintech.ugc.*,com.doublechaintech.ugc.formaction.FormAction'%>
...
<sky:include page="com/doublechaintech/ugc/formaction/FormAction$Summary.jsp" />
