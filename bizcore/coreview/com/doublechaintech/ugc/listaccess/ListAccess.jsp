<%@ page import='java.util.*,com.doublechaintech.ugc.*,com.doublechaintech.ugc.listaccess.ListAccess'%>
...
<sky:include page="com/doublechaintech/ugc/listaccess/ListAccess$Summary.jsp" />
