<%@ page import='java.util.*,com.doublechaintech.ugc.*,com.doublechaintech.ugc.review.Review'%>
...
<c:set var="ownerBeanName" value="review" scope="request"/>
<c:set var="ownerClassName" value="Review" scope="request"/>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="review" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/ugc/review/Review$Summary.jsp" />
