<%@ page import='java.util.*,com.doublechaintech.ugc.*,com.doublechaintech.ugc.product.Product'%>
...
<sky:include page="com/doublechaintech/ugc/product/Product$Summary.jsp" />
...
<sky:include page="com/doublechaintech/ugc/platform/Platform$Info.jsp" />
		...
		<c:if test='${not empty userContext.accessTokens["ratingList"] or ignoreListAccessControl}'>
		<c:set var="ratingList" value="${result.ratingList}" scope="request"/>
		<c:set var="ratingListName" value="ratingList" scope="request"/>
		<div id="ratingList" class="tab-pane fade sublist" refer-name="product">
			<sky:include page="com/doublechaintech/ugc/rating/Rating$List.jsp"
					referName="product"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["reviewList"] or ignoreListAccessControl}'>
		<c:set var="reviewList" value="${result.reviewList}" scope="request"/>
		<c:set var="reviewListName" value="reviewList" scope="request"/>
		<div id="reviewList" class="tab-pane fade sublist" refer-name="product">
			<sky:include page="com/doublechaintech/ugc/review/Review$List.jsp"
					referName="product"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["blogList"] or ignoreListAccessControl}'>
		<c:set var="blogList" value="${result.blogList}" scope="request"/>
		<c:set var="blogListName" value="blogList" scope="request"/>
		<div id="blogList" class="tab-pane fade sublist" refer-name="product">
			<sky:include page="com/doublechaintech/ugc/blog/Blog$List.jsp"
					referName="product"/>
		</div>
	</c:if>
