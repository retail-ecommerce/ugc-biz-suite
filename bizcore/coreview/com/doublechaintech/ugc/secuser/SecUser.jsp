<%@ page import='java.util.*,com.doublechaintech.ugc.*,com.doublechaintech.ugc.secuser.SecUser'%>
...
<sky:include page="com/doublechaintech/ugc/secuser/SecUser$Summary.jsp" />
...
<sky:include page="com/doublechaintech/ugc/userdomain/UserDomain$Info.jsp" />
...
<sky:include page="com/doublechaintech/ugc/secuserblocking/SecUserBlocking$Action.jsp" />
		...
		<div id="userAppList" class="tab-pane fade sublist" refer-name="sec_user">
			<sky:include page="com/doublechaintech/ugc/userapp/UserApp$List.jsp"
					referName="secUser"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["loginHistoryList"] or ignoreListAccessControl}'>
		...
		<div id="loginHistoryList" class="tab-pane fade sublist" refer-name="sec_user">
			<sky:include page="com/doublechaintech/ugc/loginhistory/LoginHistory$List.jsp"
					referName="secUser"/>
		</div>
	</c:if>
