<%@ page import='java.util.*,com.doublechaintech.ugc.*,com.doublechaintech.ugc.genericform.GenericForm'%>
...
<sky:include page="com/doublechaintech/ugc/genericform/GenericForm$Summary.jsp" />
		...
		<div id="formMessageList" class="tab-pane fade sublist" refer-name="form">
			<sky:include page="com/doublechaintech/ugc/formmessage/FormMessage$List.jsp"
					referName="form"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["formFieldMessageList"] or ignoreListAccessControl}'>
		...
		<div id="formFieldMessageList" class="tab-pane fade sublist" refer-name="form">
			<sky:include page="com/doublechaintech/ugc/formfieldmessage/FormFieldMessage$List.jsp"
					referName="form"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["formFieldList"] or ignoreListAccessControl}'>
		...
		<div id="formFieldList" class="tab-pane fade sublist" refer-name="form">
			<sky:include page="com/doublechaintech/ugc/formfield/FormField$List.jsp"
					referName="form"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["formActionList"] or ignoreListAccessControl}'>
		...
		<div id="formActionList" class="tab-pane fade sublist" refer-name="form">
			<sky:include page="com/doublechaintech/ugc/formaction/FormAction$List.jsp"
					referName="form"/>
		</div>
	</c:if>
