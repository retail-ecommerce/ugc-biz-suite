<%@ page import='java.util.*,com.doublechaintech.ugc.*,com.doublechaintech.ugc.profile.Profile'%>
...
<sky:include page="com/doublechaintech/ugc/profile/Profile$Summary.jsp" />
