<%@ page import='java.util.*,com.doublechaintech.ugc.*,com.doublechaintech.ugc.platform.Platform'%>
...
<sky:include page="com/doublechaintech/ugc/platform/Platform$Summary.jsp" />
		...
		<div id="productList" class="tab-pane fade sublist" refer-name="platform">
			<sky:include page="com/doublechaintech/ugc/product/Product$List.jsp"
					referName="platform"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["profileList"] or ignoreListAccessControl}'>
		...
		<div id="profileList" class="tab-pane fade sublist" refer-name="platform">
			<sky:include page="com/doublechaintech/ugc/profile/Profile$List.jsp"
					referName="platform"/>
		</div>
	</c:if>
