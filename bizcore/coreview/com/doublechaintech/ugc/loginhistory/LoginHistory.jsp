<%@ page import='java.util.*,com.doublechaintech.ugc.*,com.doublechaintech.ugc.loginhistory.LoginHistory'%>
...
<sky:include page="com/doublechaintech/ugc/loginhistory/LoginHistory$Summary.jsp" />
