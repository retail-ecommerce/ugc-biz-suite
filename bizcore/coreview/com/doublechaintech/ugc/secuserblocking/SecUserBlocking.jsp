<%@ page import='java.util.*,com.doublechaintech.ugc.*,com.doublechaintech.ugc.secuserblocking.SecUserBlocking'%>
...
<sky:include page="com/doublechaintech/ugc/secuserblocking/SecUserBlocking$Summary.jsp" />
