<%@ page import='java.util.*,com.doublechaintech.ugc.*,com.doublechaintech.ugc.rating.Rating'%>
...
<c:set var="ownerBeanName" value="rating" scope="request"/>
<c:set var="ownerClassName" value="Rating" scope="request"/>
...
<div class="row">
	...
	<% Rating result = (Rating)request.getAttribute("result");  %>
...
<div class="row" desc="show parent objects">
	...
	<c:set var="rating" value="${ result}" scope="request" />
<sky:include page="com/doublechaintech/ugc/rating/Rating$Summary.jsp" />
...
<sky:include page="com/doublechaintech/ugc/profile/Profile$Info.jsp" />

<c:set var="product" value="${ result.product}" scope="request" />
<sky:include page="com/doublechaintech/ugc/product/Product$Info.jsp" />
