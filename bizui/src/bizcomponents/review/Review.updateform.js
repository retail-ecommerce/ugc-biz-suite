...
import styles from './Review.updateform.less'
...
class ReviewUpdateForm extends Component {
  state = {
  ...
  render() {
    ...
    const submitUpdateForm = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, reviewId, ...imagesValues }
    ...
    const skipToNext = () => {
      ...
      const newIndex = currentUpdateIndex + 1
      dispatch({
        type: `${owner.type}/gotoNextReviewUpdateRow`,
        payload: {
          id: owner.id,
          type: 'review',
          selectedRows,
    ...
    return (
      <PageHeaderLayout
        title={"更新Review"+(currentUpdateIndex+1)+"/"+selectedRows.length}
        content="更新Review"
