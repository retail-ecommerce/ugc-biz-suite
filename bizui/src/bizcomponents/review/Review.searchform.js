...
class ReviewSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      reviewList: 1,
      'reviewList.searchField': fieldName,
      'reviewList.searchVerb': 'startsWith',
      'reviewList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`reviewList.searchField`] = fieldName
    value[`reviewList.searchVerb`] =  searchVerb
    value[`reviewList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      params['reviewList'] = 1
      params['reviewList.orderBy.0'] = "id"
      params['reviewList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        reviewSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"user"} 
                    requestFunction={ReviewService.requestCandidateUser}/>
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"product"} 
                    requestFunction={ReviewService.requestCandidateProduct}/>
...
export default Form.create()(ReviewSearchForm)
