...
<Description term="Last Update Time">{ moment(profile.lastUpdateTime).format('YYYY-MM-DD')}</Description> 
...
class ProfileDashboard extends Component {
 ...
 state = {
  ...
  render() {
    ...
    const { id,displayName, ratingListMetaInfo, reviewListMetaInfo, blogListMetaInfo, ratingCount, reviewCount, blogCount } = this.props.profile
