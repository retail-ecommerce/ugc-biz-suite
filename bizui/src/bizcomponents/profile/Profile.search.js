...
const showAssociateDialog = (targetComponent) => {
  ...
  <div>
	...
	data={{profileList:selectedRows}} owner={owner}  
...
class ProfileSearch extends PureComponent {
  ...
  render(){
    ...
    const {ProfileTable} = GlobalComponents;
    const {ProfileSearchForm} = GlobalComponents;
    ...
    return (
      <PageHeaderLayout title={`${displayName}:${this.props.name}列表`}>
        ...
        {showDeletionDialog(this,ProfileModalTable,"profileIds")}
...
export default Form.create()(ProfileSearch)
