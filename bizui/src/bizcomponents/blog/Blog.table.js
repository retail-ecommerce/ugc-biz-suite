...
import styles from './Blog.table.less'
    ...
    const operationColumn={
      ...
      render: (text, record) => (
        <span>
         ...
         { hasReadPermission(metaInfo)&&<Link to={`/blog/${record.id}/dashboard`}>{appLocaleName(userContext,"View")}</Link>}
