...
import styles from './Blog.createform.less'
import {mapBackToImageValues, mapFromImageValues} from '../../axios/tools'
import GlobalComponents from '../../custcomponents';
import BlogBase from './Blog.base'
  ...
  render() {
    ...
    const submitCreateFormAndContinue = () => {
      validateFieldsAndScroll((error, values) => {
        ...
        const parameters = { ...values, ...imagesValues }
        dispatch({
          type: `${owner.type}/addBlog`,
          payload: { id: owner.id, type: 'blog', parameters, continueNext: true },
        })
      })
    }
    ...
    const goback = () => {
      ...
      dispatch({
        ...
        payload: { id: owner.id, type: 'blog',listName:'Blog列表' },
      })
    }
              ...
              <Col lg={24} md={24} sm={24}>
                <Form.Item>
                  {getFieldDecorator('content', {
                    ...
                    <TextArea rows={4} placeholder="请输入请输入Content" />
                  )}
                </Form.Item>
              </Col>
      </Row>
