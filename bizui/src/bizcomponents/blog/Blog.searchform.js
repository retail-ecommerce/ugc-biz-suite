...
import styles from './Blog.search.less'
...
class BlogSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      blogList: 1,
      'blogList.searchField': fieldName,
      'blogList.searchVerb': 'startsWith',
      'blogList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`blogList.searchField`] = fieldName
    value[`blogList.searchVerb`] =  searchVerb
    value[`blogList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      const paramList = []
		...
		pushIfNotNull(paramList,this.buildStringSearchParameters(fieldsValue,'contains', 'content'))
      ...
      params['blogList'] = 1
      params['blogList.orderBy.0'] = "id"
      params['blogList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        blogSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"user"} 
                    requestFunction={BlogService.requestCandidateUser}/>
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"product"} 
                    requestFunction={BlogService.requestCandidateProduct}/>
...
export default Form.create()(BlogSearchForm)
