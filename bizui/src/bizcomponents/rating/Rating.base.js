...
const menuData = {menuName:"Rating", menuFor: "rating",
  		subItems: [
...
const displayColumns = [
  ...
  { title: 'Score', debugtype: 'int', dataIndex: 'score', width: '5',render: (text, record)=>renderTextCell(text,record) },
...
const RatingBase={menuData,displayColumns,fieldLabels,displayColumns}
