...
import styles from './Rating.search.less'
...
class RatingSearchForm extends PureComponent {
  state = {
    // addInputValue: '',
    // modalVisible: false,
    expandForm: false,
...
componentDidMount() {
  ...
  buildStringSearchParameters = (formValues, fieldName) => {
    ...
    return {
      ratingList: 1,
      'ratingList.searchField': fieldName,
      'ratingList.searchVerb': 'startsWith',
      'ratingList.searchValue': fieldValue,
    }
  }
  */
  buildStringSearchParameters = (formValues, searchVerb, fieldName) => {
    ...
    value[`ratingList.searchField`] = fieldName
    value[`ratingList.searchVerb`] =  searchVerb
    value[`ratingList.searchValue`] = fieldValue
  ...
  handleSearch = (e) => {
    ...
    form.validateFields((err, fieldsValue) => {
      ...
      params['ratingList'] = 1
      params['ratingList.orderBy.0'] = "id"
      params['ratingList.descOrAsc.0'] = "desc"
      ...
      dispatch({
        ...
        ratingSearchFormParameters: filterObjectKeys(fieldsValue),
 ...
 <Col md={8} sm={24}>
               ...
               <SelectObject 
                 ...
                 targetType={"user"} 
                 requestFunction={RatingService.requestCandidateUser}/>
 ...
 <Col md={8} sm={24}>
                  ...
                  <SelectObject 
                    ...
                    targetType={"product"} 
                    requestFunction={RatingService.requestCandidateProduct}/>
...
export default Form.create()(RatingSearchForm)
